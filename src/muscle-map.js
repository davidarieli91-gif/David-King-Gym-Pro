...
const _mmEsc = (v) => String(v == null ? '' : v)
  ...
  .replace(/"/g, '&quot;').replace(/'/g, '&#39;');
    ...
    const SYNERGIST_CANONICAL = {
      ...
      'pectoralis major sternal head': 'chest', 'pectoralis major clavicular head': 'chest',
      // back
      ...
      'trapezius': 'back', 'traps': 'back', 'rhomboids': 'back', 'teres minor': 'back', 'teres major': 'back',
      'trapezius upper fibers': 'back', 'trapezius middle fibers': 'back', 'trapezius lower fibers': 'back',
      'infraspinatus': 'back', 'subscapularis': 'back', 'splenius': 'back',
      'levator scapulae': 'back', 'levator_scapulae': 'back',
      ...
      'deltoid anterior': 'shoulders', 'deltoid lateral': 'shoulders', 'deltoid posterior': 'shoulders',
      ...
      'biceps': 'elbow_flexors', 'biceps brachii': 'elbow_flexors', 'brachialis': 'elbow_flexors', 'brachioradialis': 'elbow_flexors',
      ...
      'rectus_abdominis': 'abdominals', 'transverse abdominus': 'abdominals', 'transverse abdominis': 'abdominals',
      'upper_abs': 'abdominals', 'upper abs': 'abdominals',
      // legs
      ...
      'adductor magnus': 'legs', 'adductor longus': 'legs', 'adductor brevis': 'legs',
      'groin': 'legs', 'inner thighs': 'legs', 'gracilis': 'legs', 'pectineous': 'legs', 'pectineus': 'legs',
      'sartorius': 'legs', 'tensor fasciae latae': 'legs', 'iliopsoas': 'legs',
      'deep hip external rotators': 'legs',
