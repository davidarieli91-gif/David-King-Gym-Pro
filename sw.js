...
const CACHE_NAME = 'dk-gym-v101'; // v101: c74 — members-only app (router auth gate), atlas lang button, DKBody3D embedded widget (SVG/3D/Both body-map modes + Settings switch)
